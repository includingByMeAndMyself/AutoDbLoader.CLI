...
namespace AutoDbLoader.DAL.txt.Infrastructure
{
    ...
    {
        public const int PAY_PAYER = 0;
        public const int PAY_ADDRESS = 1;
        public const int PAY_PERSONAL_ACCOUNT = 2;
        public const int PAY_DEBT = 3;
        public const int PAY_BIK = 4;
        public const int PAY_PAYMENT_ACCOUNT = 5;
        public const int PAY_INN = 6;
        public const int PAY_RECIPIENT = 7;
